...
if (
    args.massMin is not None
    and args.massMax is not None
    and args.massMin >= args.massMax
):
...
def make_active_background(template_hist, active_cells, shape_axis="mass"):
    ...
    if isinstance(shape_metadata, dict) and "physical_widths_nd" in shape_metadata:
    ...
    elif isinstance(shape_metadata, dict) and "physical_widths" in shape_metadata:
